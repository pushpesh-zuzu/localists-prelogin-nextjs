export default function FindLocalServices() {
    return (
        <div className="text-center px-5 py-[44px]">
            <h2 className="font-black text-[30px] md:text-[35px] lg:text-[50px] leading-[28px]  md:leading-[35px] lg:leading-[55px] tracking-[-0.03em] font-inter text-black text-center mb-[13px]">
