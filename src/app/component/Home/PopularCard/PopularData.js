...
export const mobileCarouselData = [
    {
        ...
        jobs: [
            {
                id: 1,
                image: <TreeIcon className="max-[360px]:max-h-[35px]" />,
                title: "Tree surgeon",
                path: "/en/gb/tree-surgeon-near-me",
                margin: "mx-4",
            },
            {
                id: 2,
                image: <FenceAndGateInstallationIcon  className="max-[360px]:max-h-[35px]" />,
            ...
            {
                id: 3,
                image: <DrivewayIcon className="max-[360px]:max-h-[30px]" />,
            ...
            {
                id: 4,
                image: <PatioLayingIcon className="max-[360px]:max-h-[26px]"/>,
                title: "Patio Laying",
                margin: "mx-2.5",
                path: "/en/gb/patio-layers-near-me",
            },
            {
                id: 5,
                image: <LandscapingPopularJobsIcon className="max-[360px]:max-h-[26px]"/>,
                title: "Landscaping",
                margin: "mx-2.5",
                path: "/en/gb/landscape-gardeners-near-me",
            },
            {
                id: 6,
                image: <ArtificialGrassIcon className="max-[360px]:max-h-[26px]"/>,
                title: "Artificial Grass Installation",
                margin: "mx-0",
