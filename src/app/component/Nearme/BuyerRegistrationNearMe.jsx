...
import { setBuyerStep, questionAnswerData } from "@/lib/store/buyerslice/buyerSlice";
...
import QuestionAnswersModalNearMe from "./QuestionAnswersModalNearMe";
import ConfirmationModal from "../common/BuyerRegistration/ConfirmationModal";
import DemoNameAndEmail from "./DemoNameAndEmail";
...
function BuyerRegistrationNearMe({
    ...
    useEffect(() => {
        if (
            hasFetchedQuestionsRef.current ||
            !service_Id ||
            (questionanswerData && questionanswerData.length > 0)
        ) {
            return;
        }
    ...
    }, [service_Id, dispatch, questionanswerData?.length]);
