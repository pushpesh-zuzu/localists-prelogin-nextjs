    ...
    <WrapperBGWidth>
      <div className="md:block p-[10px] min-[358px]:p-[35px]  sm:px-10 md:px-16 md:py-10 xl:px-[120px] xl:pt-[71px] xl:pb-[72px]">
        ...
        <div className="pt-4 lg:pt-10 lg:pt-[58px]">
          ...
          />
          <div className="mt-5 md:mt-6 lg:mt-12 flex flex-col gap-[30px] md:gap-[15px] lg:gap-12">
            {paragraph.map((item, index) => (
              <Paragraph bold="font-bold" variant="primarySmall" key={index}>
                {item}
              </Paragraph>
            ))}
            <div className="flex flex-wrap justify-center md:justify-start gap-[7px] gap-2.5 lg:gap-6 mb-2.5 mt-0 md:mt-[5px] lg:mt-3 lg:mt-0">
