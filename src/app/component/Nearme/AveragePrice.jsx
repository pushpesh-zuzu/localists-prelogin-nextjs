          ...
          <div className="flex flex-col lg:flex-row lg:gap-6">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-2 gap-x-[14px] gap-y-5 lg:gap-x-5 px-[17px] min-[450px]:px-20 lg:px-0 py-[23px] lg:py-16 lg:pr-7">
              ...
              <div className="h-full">
                ...
                <p className=" text-4xl lg:text-5xl tracking-[-0.03em] font-black text-center min-[450px]:text-center md:text-center text-[#253238] max-[336px]:mt-[24px] mt-6 md:mt-3 sm:mt-4">
                  £250
                </p>
              </div>
