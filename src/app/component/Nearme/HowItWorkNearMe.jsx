  ...
  return (
    <WrapperBGWidth background={"white"}>
      <section className="bg-white h-auto px-2.5 pt-12 pb-[30px] sm:px-10 md:px-16 md:pb-10 md:pt-0 xl:px-[145px] xl:pb-[72px]">
        <H2 className="text-[#00afe3] pb-[30px] md:pb-6 xl:pb-[47.89px]">
        ...
        <div className="flex justify-center">
          <Button variant="secondary" onClick={()=>{handleScrollToBottom()}} className="cursor-pointer rounded-[94px] max-w-fit bg-[#10C87B] text-white mt-[30px] px-4 py-2 lg:mt-[47px] md:py-1.5 md:px-4.5 lg:py-2 lg:px-8 ">
            Get Started
          </Button>
        </div>
      </section>
