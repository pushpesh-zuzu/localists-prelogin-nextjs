    ...
    <WrapperBGWidth>
      ...
      >
          ...
          <div className="grid grid-cols-3 sm:gap-2 lg:gap-4">
            <article className="col-span-1 relative rounded-3xl md:rounded-[28px] overflow-hidden h-[170px] lg:h-[336px] group cursor-pointer">
              <Image
                ...
                priority={false}
              />
              <div className="absolute inset-0 bg-[linear-gradient(180deg, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.5) 100%)]"></div>
        ...
        <div className="flex justify-center mt-6 xl:mt-12">
          ...
          <HowItWorkCTA enableScroll={false} text={'Read More'} marginTop="mt-0"/>
          </a>
        </div>
      </section>
    </WrapperBGWidth>
...
export default AdviceInsightNearMe;
