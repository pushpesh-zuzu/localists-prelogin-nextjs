...
function HeroSectionNearMeOtherTheHome({
        ...
        <div className="relative z-10 max-w-[1536px] mx-auto h-full">
          ...
          >
            <div className="w-full flex flex-col relative z-10">
              ...
              <PostCodeSearchField marginTop="mt-[30px] md:mt-6 lg:mt-9" serviceId={serviceId} serviceName={serviceName} />
            </div>
...
export default HeroSectionNearMeOtherTheHome;
