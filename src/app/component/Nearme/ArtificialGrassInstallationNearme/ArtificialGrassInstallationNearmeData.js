export const QUESTION_AND_ABOUT_SERVICE_ARTIFICIAL_GRASS_NEARME = [
  {
    type: "image",
    src: "/nearme/Artificial/artificialTurf.webp",
    alt: "professional installer using expert equipment to lay artificial turf in a residential yard.",
    marginBottom: true,
  },
  {
    type: "h2",
...
export const FREQUENTLY_DATA_ARTIFICIAL_GRASS_NEARME = [
  ...
  },
  {
    ...
    description: `
      When fitted correctly, an artificial lawn  drains just as well as natural lawns. Sometimes even better. The base layer of crushed stone or sharp sand allows water to flow away quickly, preventing puddles. 
      </br></br>
  ...
  },
  {
    ...
    description: `
      Yes, it’s possible to lay artificial turf over concrete, tarmac, or decking with the right preparation. Your artificial grass installer may add an underlay for cushioning and drainage, making the surface softer underfoot. This option is ideal for small gardens, balconies, and roof terraces where natural turf isn’t possible.
      </br></br>
