...
export default function LandScapingGardenPopularJobs({
  ...
  return (
    <WrapperBGWidth>
      ...
      <div className={`md:block rounded-[20px] md:rounded-none mx-[30px] md:mx-0 mt-2.5 md:mt-0 bg-[#00AFE3] md:bg-white ${isPaddingBottom ? "px-[17.5px] py-[30px] sm:px-10 md:px-16 lg:px-16 md:pb-0 xl:px-[120px] pt-0 xl:pb-0" : "px-[17.5px] py-[30px]  sm:px-10 md:px-16 lg:px-16 md:pb-10 xl:px-[120px] pt-0 xl:pb-[100px]"} `}>
  ...
  height = { 600}
  fetchPriority = "high"
  className = "hidden md:block w-auto h-[382px] lg:h-[380px] xl:h-[501.5px] xl:w-[400px] absolute md:-right-33 min-[900px]:-right-25! lg:-right-19! xl:-right-14! bottom-0 z-[18px] pointer-events-none"
    />
