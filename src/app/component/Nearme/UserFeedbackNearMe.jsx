    ...
    <WrapperBGWidth background={"#edfcf8"}>
      <div className="h-auto min-h-[400px] lg:min-h-[687px] px-2.5 py-[30px] sm:px-10 md:px-16 md:py-[38px] xl:px-[120px] lg:py-[72px] bg-[#EDFCF8]">
        ...
        <div className="flex justify-center">
          <Button onClick={()=>{handleScrollToBottom()}} className="cursor-pointer px-[15px] py-2 xl:py-[15px] xl:px-7 mt-8 xl:mt-12 rounded-full bg-[#253238] text-white shadow-[0_0_4px_rgba(0,0,0,0.1)]">
            Get your Quote
          </Button>
        </div>
      </div>
