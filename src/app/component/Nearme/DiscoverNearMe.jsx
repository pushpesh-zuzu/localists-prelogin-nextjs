...
function DiscoverNearMe({ homeData = [], businessData = [], eventData = [], title, background ="#fff" }) {
  return (
    <WrapperBGWidth background={background}>
      <div className="  md:block px-[30px] py-5 sm:px-10 md:px-16 md:py-10 xl:px-[120px] pt-10 pb-10 lg:pt-[72px] lg:pb-[72px] xl:pt-[72px] xl:pb-[72px]">
