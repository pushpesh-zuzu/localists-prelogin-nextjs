...
function NearmeMember({ description = "" }) {
  return (
    <div className="w-full max-w-[303px] sm:max-w-xl md:max-w-3xl lg:max-w-5xl xl:max-w-[1200px] mx-auto pt-10 pb-10  md:py-[0px] md:pb-10 md:pt-10 lg:pb-0 xl:pt-[72px] xl:pb-[72px]">
