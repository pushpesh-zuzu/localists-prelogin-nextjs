...
export default function PopularJobNearMe({ services = [] }) {
  return (
    <WrapperBGWidth>
      ...
      <div className="md:block bg-[#00AFE3] md:bg-white  px-2.5 py-[30px] sm:px-10 md:px-16 md:py-10 xl:px-[120px] pt-0 xl:pb-[72px]">
        <div className="md:max-w-[646px] lg:max-w-[900px] xl:max-w-[1200px] xl:h-[470px] relative overflow-visible">
          {/* 1️⃣ Shape background */}
          <div
            className="md:rounded-[40px] absolute inset-0 bg-[#00AFE3]
