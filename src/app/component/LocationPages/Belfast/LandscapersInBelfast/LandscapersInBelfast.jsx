...
import {
    BREADCRUM_DATA_LANDSCAPING_BELFAST,
    LANDSCAPING_FAQ_BELFAST,
    POPULAR_SERVICES_LANDSCAPING_BELFAST,
    QUESTION_AND_ABOUT_SERVICE_LANDSCAPING_BELFAST,
    LANDSCAPING_ADVICEINSIGHT_BELFAST,
    LANDSCAPING_FEEDBACK_BELFAST,
    LANDSCAPING_DATA_BELFAST,
    LANDSCAPING_TABDATA_BELFAST,
    VETTED_DATA_LANDSCAPING_BELFAST,
    NEARBY_PLACES_ROOFER_BELFAST
} from "./LandscapersInBelfastData";
...
function LandscapersInBelfast() {
    ...
    return (
        <>
            ...
            <FAQScript FAQ={LANDSCAPING_FAQ_BELFAST} />
            <HeroSectionLocation 
                heading1="Landscapers"
                heading2="Belfast"
                description="Looking for skilled landscapers in Belfast? Look no further! Popping your postcode and a few quick details of what needs doing below, and receive up to five free codes in your inbox in minutes. It’s really that easy."
            ...
            />
            <VettedSection
                paragraph={VETTED_DATA_LANDSCAPING_BELFAST}
                vettedHeading1="Find Local Vetted Landscapers in "
                vettedHeading2="Belfast"
                breadcrumb={BREADCRUM_DATA_LANDSCAPING_BELFAST}
                extraButton
                featureRef={featureRef}
                featureButtonText="View Landscapers"
            />
            <LandScapingGardenPopularJobs
                services={POPULAR_SERVICES_LANDSCAPING_BELFAST}
            ...
            <AboutServicesAndQuestions
                serviceId={43}
                serviceName="Landscaping"
                contentBlocks={QUESTION_AND_ABOUT_SERVICE_LANDSCAPING_BELFAST}
                quotesBannerText="GET A QUOTES IN"
                mobileFrame="/nearme/Landscaping/mobilelandscaping.webp"
            />

            <div ref={featureRef} style={{ overflowAnchor: "none" }}>
                <Feature county='County Antrim' cityName='Belfast' serviceId={43} serviceName="Landscaping" featureRef={featureRef} serviceProfessionName="Landscapers" />
            </div>

            <HireRelatedToServiceNearMe
                heading1="Hire with"
                heading2="confidence."
                tabData={LANDSCAPING_TABDATA_BELFAST}
                activeTabkey="popular"
            />
            <AdviceInsightNearMe
                articles={LANDSCAPING_ADVICEINSIGHT_BELFAST}
            ...
            <FAQ
                ...
                headdingblue="FAQ's"
                headingblack=""
                data={LANDSCAPING_FAQ_BELFAST}
            />
            <UserFeedbackNearMe2 feedbackData={LANDSCAPING_FEEDBACK_BELFAST} />
            <DiscoverNearMe homeData={LANDSCAPING_DATA_BELFAST} />
            <NearmeMember
            ...
            />
            {/* <NearbyPlaces NearByPlacesData={NEARBY_PLACES_ROOFER_BELFAST}/> */}
            <Footer />
        </>
    );
}
export default LandscapersInBelfast;