...
import {
  BREADCRUM_DATA_ROOFERS_GLOSSOP,
  ROOFERS_FREQUENTLY_DATA_GLOSSOP,
  POPULAR_SERVICES_ROOFERS_GLOSSOP,
  QUESTION_AND_ABOUT_SERVICE_ROOFERS_GLOSSOP,
  ROOFERS_ADVICEINSIGHT_GLOSSOP,
  ROOFERS_FEEDBACK_GLOSSOP,
  ROOFERS_DATA_GLOSSOP,
  ROOFERS_TABDATA_GLOSSOP,
  VETTED_DATA_ROOFERS_GLOSSOP,
  NEARBY_PLACES_ROOFER_GLOSSOP
} from "./RoofersInGlossopData";
...
function RoofersInGlossop() {
  ...
  return (
    <>
      ...
      <FAQScript FAQ={ROOFERS_FREQUENTLY_DATA_GLOSSOP} />
      <HeroSectionLocation 
        heading1="Roofers"
        heading2="Glossop"
        description="Looking to fix a bad spot on your roof or get a full replacement? Enter your postcode, and a few quick details to receive 5 free no-obligation quotes from the best local roofing professionals in your area. It only takes a minute."
      ...
      />
      <VettedSection
        paragraph={VETTED_DATA_ROOFERS_GLOSSOP}
        vettedHeading1="Find Local Vetted Roofers in "
        vettedHeading2="Glossop"
        breadcrumb={BREADCRUM_DATA_ROOFERS_GLOSSOP}
        extraButton
        featureRef={featureRef}
      />

      <PopularJobNearMe
        services={POPULAR_SERVICES_ROOFERS_GLOSSOP}
      ...
      <AboutServicesAndQuestions
        serviceId={113}
        serviceName="Roofing"
        contentBlocks={QUESTION_AND_ABOUT_SERVICE_ROOFERS_GLOSSOP}
      />
      ...
      <FAQ
        ...
        data={ROOFERS_FREQUENTLY_DATA_GLOSSOP}
      />
      <UserFeedbackNearMe2 feedbackData={ROOFERS_FEEDBACK_GLOSSOP} />
      <DiscoverNearMe homeData={ROOFERS_DATA_GLOSSOP} />
      <NearmeMember
        description={`“The thing I like about Localists is they don’t tie you down to any monthly contracts and the leads are generally better.  When I’m quiet, I just hop on the website and get a few leads to tie me over.”`}
        desktopImage="/nearme/Roofing/roofingmember.webp"
        mobileImage="/nearme/Roofing/roofingmembermobile.webp"
      />
      <NearbyPlaces NearByPlacesData={NEARBY_PLACES_ROOFER_GLOSSOP} />
      <Footer />
    </>
  );
}
export default RoofersInGlossop;
