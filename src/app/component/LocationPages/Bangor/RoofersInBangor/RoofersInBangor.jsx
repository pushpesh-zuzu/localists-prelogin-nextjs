...
import {
  BREADCRUM_DATA_ROOFERS_BANGOR,
  ROOFERS_FREQUENTLY_DATA_BANGOR,
  POPULAR_SERVICES_ROOFERS_BANGOR,
  QUESTION_AND_ABOUT_SERVICE_ROOFERS_BANGOR,
  ROOFERS_ADVICEINSIGHT_BANGOR,
  ROOFERS_FEEDBACK_BANGOR,
  ROOFERS_DATA_BANGOR,
...
function RoofersInBangor() {
  ...
  return (
    <>
      ...
      />
      <VettedSection
        paragraph={VETTED_DATA_ROOFERS_BANGOR}
        vettedHeading1="Find Local Vetted Roofers in "
        vettedHeading2="Bangor"
        breadcrumb={BREADCRUM_DATA_ROOFERS_BANGOR}
        extraButton
        featureRef={featureRef}
      />

      <PopularJobNearMe
        services={POPULAR_SERVICES_ROOFERS_BANGOR}
      ...
      <AboutServicesAndQuestions
        serviceId={113}
        serviceName="Roofing"
        contentBlocks={QUESTION_AND_ABOUT_SERVICE_ROOFERS_BANGOR}
      />
      ...
      <FAQ
        ...
        data={ROOFERS_FREQUENTLY_DATA_BANGOR}
      />
...
export default RoofersInBangor;