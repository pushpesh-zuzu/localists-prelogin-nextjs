...
import {
  BREADCRUM_DATA_ROOFERS_WIDNES,
  ROOFERS_FREQUENTLY_DATA_WIDNES,
  POPULAR_SERVICES_ROOFERS_WIDNES,
  QUESTION_AND_ABOUT_SERVICE_ROOFERS_WIDNES,
  ROOFERS_ADVICEINSIGHT_WIDNES,
  ROOFERS_FEEDBACK_WIDNES,
  ROOFERS_DATA_WIDNES,
  ROOFERS_TABDATA_WIDNES,
  VETTED_DATA_ROOFERS_WIDNES,
  NEARBY_PLACES_ROOFER_WIDNES
} from "./RoofersInWidnesData";
...
function RoofersInWidnes() {
  ...
  return (
    <>
      ...
      <FAQScript FAQ={ROOFERS_FREQUENTLY_DATA_WIDNES} />
      <HeroSectionLocation 
        heading1="Roofers"
        heading2="Widnes"
        description="Need a local roofer you can trust for your roofing project in Widnes? Get free no-obligation quotes from high quality roofers in your local area. Enter your postcode, tell us what the problem might be, and local vetted professionals will reach out to you within minutes. "
      ...
      />
      <VettedSection
        paragraph={VETTED_DATA_ROOFERS_WIDNES}
        vettedHeading1="Find Local Vetted Roofers in "
        vettedHeading2="Widnes"
        breadcrumb={BREADCRUM_DATA_ROOFERS_WIDNES}
        extraButton
        featureRef={featureRef}
      />

      <PopularJobNearMe
        services={POPULAR_SERVICES_ROOFERS_WIDNES}
      ...
      <AboutServicesAndQuestions
        serviceId={113}
        serviceName="Roofing"
        contentBlocks={QUESTION_AND_ABOUT_SERVICE_ROOFERS_WIDNES}
      />

      <div ref={featureRef} style={{ overflowAnchor: "none" }}>
        <Feature county='Halton' cityName='Widnes' serviceId={113} serviceName="Roofing" featureRef={featureRef} />
      </div>
      ...
      />
      <AdviceInsightNearMe
        articles={ROOFERS_ADVICEINSIGHT_WIDNES}
      ...
      <FAQ
        ...
        data={ROOFERS_FREQUENTLY_DATA_WIDNES}
      />
      <UserFeedbackNearMe2 feedbackData={ROOFERS_FEEDBACK_WIDNES} />
      <DiscoverNearMe homeData={ROOFERS_DATA_WIDNES} />
      <NearmeMember
        description={`“The thing I like about Localists is they don’t tie you down to any monthly contracts and the leads are generally better.  When I’m quiet, I just hop on the website and get a few leads to tie me over.”`}
        desktopImage="/nearme/Roofing/roofingmember.webp"
        mobileImage="/nearme/Roofing/roofingmembermobile.webp"
        />
        <NearbyPlaces NearByPlacesData={NEARBY_PLACES_ROOFER_WIDNES}/>
      <Footer />
    </>
  );
}
export default RoofersInWidnes;