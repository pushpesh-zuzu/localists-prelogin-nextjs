...
import {
    BREADCRUM_DATA_ROOFERS_DRIFFIELD,
    ROOFERS_FREQUENTLY_DATA_DRIFFIELD,
    POPULAR_SERVICES_ROOFERS_DRIFFIELD,
    QUESTION_AND_ABOUT_SERVICE_ROOFERS_DRIFFIELD,
    ROOFERS_ADVICEINSIGHT_DRIFFIELD,
    ROOFERS_FEEDBACK_DRIFFIELD,
...
function RoofersInDriffield() {
    ...
    return (
        <>
            ...
            />
            <VettedSection
                paragraph={VETTED_DATA_ROOFERS_DRIFFIELD}
                vettedHeading1="Find Local Vetted Roofers in "
                vettedHeading2="Driffield"
                breadcrumb={BREADCRUM_DATA_ROOFERS_DRIFFIELD}
                extraButton
                featureRef={featureRef}
            />

            <PopularJobNearMe
                services={POPULAR_SERVICES_ROOFERS_DRIFFIELD}
            ...
            <AboutServicesAndQuestions
                serviceId={113}
                serviceName="Roofing"
                contentBlocks={QUESTION_AND_ABOUT_SERVICE_ROOFERS_DRIFFIELD}
            />
            ...
            <FAQ
                ...
                data={ROOFERS_FREQUENTLY_DATA_DRIFFIELD}
            />
...
export default RoofersInDriffield;