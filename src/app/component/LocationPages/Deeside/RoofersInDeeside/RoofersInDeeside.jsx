...
import {
  BREADCRUM_DATA_ROOFERS_DEESIDE,
  ROOFERS_FREQUENTLY_DATA_DEESIDE,
  POPULAR_SERVICES_ROOFERS_DEESIDE,
  QUESTION_AND_ABOUT_SERVICE_ROOFERS_DEESIDE,
  ROOFERS_ADVICEINSIGHT_DEESIDE,
  ROOFERS_FEEDBACK_DEESIDE,
...
function RoofersInDeeside() {
  ...
  return (
    <>
      ...
      <PopularJobNearMe
        services={POPULAR_SERVICES_ROOFERS_DEESIDE}
      ...
      <AboutServicesAndQuestions
        serviceId={113}
        serviceName="Roofing"
        contentBlocks={QUESTION_AND_ABOUT_SERVICE_ROOFERS_DEESIDE}
      />
...
export default RoofersInDeeside;