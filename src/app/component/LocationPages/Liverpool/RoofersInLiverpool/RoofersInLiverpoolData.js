...
export const POPULAR_SERVICES_ROOFERS_LIVERPOOL = [
  "Roof Repair",
  "Flashing",
  "Waterproofing",
  "Roof Replacement",
...
export const ROOFERS_DATA_LIVERPOOL = [
  {
    id: 1,
    title: "Home & Garden",
