export const QUESTION_AND_ABOUT_SERVICE_ROOFERS_WARRINGTON = [
  {
    type: "h2",
    text: "How much will a roofing job cost in Warrington?",
  },
  {
    type: "p",
  ...
  {
    type: "pbold",
    text: "Roof installations and replacements",
  },
  {
    type: "li",
    text: "Flat roof installation: £1,427–£2,877, average £2,037",
  },
  {
    type: "li",
  ...
  {
    type: "li",
    text: "Storm damage from strong winds or heavy rain",
  },
  {
    type: "li",
    text: "Loose, cracked, or missing tiles",
  },
  {
    type: "li",
    text: "Flashing failure, letting water sneak in",
  },
  {
    type: "li",
    text: "Flat roof leaks or water pooling",
  },
  {
    type: "li",
    text: "Damaged gutters or chimneys after storms or debris",
  },
  {
    type: "p",
...
export const ROOFERS_ADVICEINSIGHT_WARRINGTON = [
  {
    id: 1,
...
export const ROOFERS_TABDATA_WARRINGTON = {
  popular: [
    {
...
export const POPULAR_SERVICES_ROOFERS_WARRINGTON = [
  "Roof Repair",
  "Flashing",
  "Waterproofing",
  "Roof Replacement",
