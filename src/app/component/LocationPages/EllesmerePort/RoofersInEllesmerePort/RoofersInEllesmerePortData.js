export const QUESTION_AND_ABOUT_SERVICE_ROOFERS_ELLESMEREPORT = [
  {
    type: "h2",
    text: "Why hire Ellesmere Port Roofers through Localists?",
  },
  {
    type: "p",
  ...
  {
    type: "p",
    text: "Not random listings. Real roofers working in and around Ellesmere Port and who understand the area.",
  },
  {
    type: "pbold",
  ...
  {
    type: "h2",
    text: "What do roofers in Ellesmere Port usually charge?",
  },
  {
    type: "p",
...
export const FREQUENTLY_DATA_ELLESMEREPORT = [
  ...
  },
  {
    key: "2",
    title:
      "How many years should you wait  before you should replace your roof?",
    description: `
...
export const ROOFERS_ADVICEINSIGHT_ELLESMEREPORT = [
  {
    id: 1,
...
export const ROOFERS_TABDATA_ELLESMEREPORT = {
  popular: [
    {
...
export const VETTED_DATA_ROOFERS_ELLESMEREPORT = [
  ...
  `,
  `
If you’re looking for roofers in Ellesmere Port, you don’t have to spend hours searching. We’ll match you with qualified contractors in your area in minutes. Simply tell us what you need, and receive free quotes directly to your inbox. No hard sales. No pressure to hire.
`,
];

export const BREADCRUM_DATA_ROOFERS_ELLESMEREPORT = [
...
export const POPULAR_SERVICES_ROOFERS_ELLESMEREPORT = [
  "Roof Repair",
  "Flashing",
  "Waterproofing",
  "Roof Replacement",
...
export const ROOFERS_FEEDBACK_ELLESMEREPORT = [
  {
    id: 1,
...
export const ROOFERS_DATA_ELLESMEREPORT = [
  {
    id: 1,
    title: "Home & Garden",
