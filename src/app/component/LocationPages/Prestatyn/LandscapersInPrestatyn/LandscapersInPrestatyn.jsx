...
import {
  BREADCRUM_DATA_LANDSCAPING_PRESTATYN,
  LANDSCAPING_FAQ_PRESTATYN,
  POPULAR_SERVICES_LANDSCAPING_PRESTATYN,
  QUESTION_AND_ABOUT_SERVICE_LANDSCAPING_PRESTATYN,
  LANDSCAPING_ADVICEINSIGHT_PRESTATYN,
  LANDSCAPING_FEEDBACK_PRESTATYN,
  LANDSCAPING_DATA_PRESTATYN,
  LANDSCAPING_TABDATA_PRESTATYN,
  VETTED_DATA_LANDSCAPING_PRESTATYN,
  NEARBY_PLACES_ROOFER_PRESTATYN,
} from "./LandscapersInPrestatynData";
...
function LandscapersInPrestatyn() {
  useScrollToTop();
  ...
  return (
    <>
      ...
      <FAQScript FAQ={LANDSCAPING_FAQ_PRESTATYN} />
      <HeroSectionLocation
        heading1="Landscapers"
        heading2="Prestatyn"
        description="Need reliable landscapers in Prestatyn? Pop in your postcode, give us a few key details, and you’ll receive multiple free quotes from top landscapers in the area. It’s that fast and easy."
      ...
      />
      <VettedSection
        paragraph={VETTED_DATA_LANDSCAPING_PRESTATYN}
        vettedHeading1="Find Local Vetted Landscapers in "
        vettedHeading2="Prestatyn"
        breadcrumb={BREADCRUM_DATA_LANDSCAPING_PRESTATYN}
        extraButton
        featureRef={featureRef}
        featureButtonText="View Landscapers"
      />
      <LandScapingGardenPopularJobs
        services={POPULAR_SERVICES_LANDSCAPING_PRESTATYN}
      ...
      <AboutServicesAndQuestions
        serviceId={43}
        serviceName="Landscaping"
        contentBlocks={QUESTION_AND_ABOUT_SERVICE_LANDSCAPING_PRESTATYN}
      ...
      <HireRelatedToServiceNearMe
        heading1="Hire with"
        heading2="confidence."
        tabData={LANDSCAPING_TABDATA_PRESTATYN}
        activeTabkey="popular"
      />
      <AdviceInsightNearMe
        articles={LANDSCAPING_ADVICEINSIGHT_PRESTATYN}
      ...
      <FAQ
        ...
        headdingblue="FAQ's"
        headingblack=""
        data={LANDSCAPING_FAQ_PRESTATYN}
      />
      <UserFeedbackNearMe2 feedbackData={LANDSCAPING_FEEDBACK_PRESTATYN} />
      <DiscoverNearMe homeData={LANDSCAPING_DATA_PRESTATYN} />
      <NearmeMember
      ...
      />
      <NearbyPlaces NearByPlacesData={NEARBY_PLACES_ROOFER_PRESTATYN} />
      <Footer />
    </>
  );
}
export default LandscapersInPrestatyn;
