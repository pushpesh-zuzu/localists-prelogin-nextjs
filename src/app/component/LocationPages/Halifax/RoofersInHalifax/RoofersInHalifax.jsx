...
import {
    BREADCRUM_DATA_ROOFERS_HALIFAX,
    ROOFERS_FREQUENTLY_DATA_HALIFAX,
    POPULAR_SERVICES_ROOFERS_HALIFAX,
    QUESTION_AND_ABOUT_SERVICE_ROOFERS_HALIFAX,
    ROOFERS_ADVICEINSIGHT_HALIFAX,
    ROOFERS_FEEDBACK_HALIFAX,
    ROOFERS_DATA_HALIFAX,
    ROOFERS_TABDATA_HALIFAX,
    VETTED_DATA_ROOFERS_HALIFAX,
    NEARBY_PLACES_ROOFER_HALIFAX
} from "./RoofersInHalifaxData";
...
function RoofersInHalifax() {
    ...
    return (
        <>
            ...
            />
            <VettedSection
                paragraph={VETTED_DATA_ROOFERS_HALIFAX}
                vettedHeading1="Find Local Vetted Roofers in "
                vettedHeading2="Halifax"
                breadcrumb={BREADCRUM_DATA_ROOFERS_HALIFAX}
                extraButton
                featureRef={featureRef}
            />

            <PopularJobNearMe
                services={POPULAR_SERVICES_ROOFERS_HALIFAX}
            ...
            <AboutServicesAndQuestions
                serviceId={113}
                serviceName="Roofing"
                contentBlocks={QUESTION_AND_ABOUT_SERVICE_ROOFERS_HALIFAX}
            />
            ...
            <FAQ
                ...
                headdingblue="FAQ's"
                headingblack=""
                data={ROOFERS_FREQUENTLY_DATA_HALIFAX}
            />
...
export default RoofersInHalifax;