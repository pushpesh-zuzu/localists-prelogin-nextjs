...
import {
    BREADCRUM_DATA_ROOFERS_NORTH_SHIELDS,
    ROOFERS_FREQUENTLY_DATA_NORTH_SHIELDS,
    POPULAR_SERVICES_ROOFERS_NORTH_SHIELDS,
    QUESTION_AND_ABOUT_SERVICE_ROOFERS_NORTH_SHIELDS,
    ROOFERS_ADVICEINSIGHT_NORTH_SHIELDS,
    ROOFERS_FEEDBACK_NORTH_SHIELDS,
    ROOFERS_DATA_NORTH_SHIELDS,
    ROOFERS_TABDATA_NORTH_SHIELDS,
    VETTED_DATA_ROOFERS_NORTH_SHIELDS,
    NEARBY_PLACES_ROOFER_NORTH_SHIELDS
} from "./RoofersInNorthShieldsData";
...
function RoofersInNorthShields() {
    useScrollToTop()
    ...
    return (
        <>
            ...
            <FAQScript FAQ={ROOFERS_FREQUENTLY_DATA_NORTH_SHIELDS} />
            <HeroSectionLocation 
                heading1="Roofers"
                heading2="North Shields"
                description="Get free, no-obligation quotes from the best Roofers in North Shields. Just enter your postcode, give us a few more details, and instantly get matched with trusted local roofers in your area."
            ...
            />
            <VettedSection
                paragraph={VETTED_DATA_ROOFERS_NORTH_SHIELDS}
                vettedHeading1="Find Local Vetted Roofers in "
                vettedHeading2="North Shields"
                breadcrumb={BREADCRUM_DATA_ROOFERS_NORTH_SHIELDS}
                extraButton
                featureRef={featureRef}
            />

            <PopularJobNearMe
                services={POPULAR_SERVICES_ROOFERS_NORTH_SHIELDS}
            ...
            <AboutServicesAndQuestions
                serviceId={113}
                serviceName="Roofing"
                contentBlocks={QUESTION_AND_ABOUT_SERVICE_ROOFERS_NORTH_SHIELDS}
            />

            <div ref={featureRef} style={{ overflowAnchor: "none" }}>
                <Feature cityName="North Shields" county='North Tyneside' serviceId={113} serviceName="Roofing" featureRef={featureRef} />
            </div>
            ...
            />
            <AdviceInsightNearMe
                articles={ROOFERS_ADVICEINSIGHT_NORTH_SHIELDS}
            ...
            <FAQ
                ...
                headdingblue="FAQ's"
                headingblack=""
                data={ROOFERS_FREQUENTLY_DATA_NORTH_SHIELDS}
            />
...
export default RoofersInNorthShields;
