...
import {
  BREADCRUM_DATA_ROOFERS_NORTH_WALES,
  ROOFERS_FREQUENTLY_DATA_NORTH_WALES,
  POPULAR_SERVICES_ROOFERS_NORTH_WALES,
  QUESTION_AND_ABOUT_SERVICE_ROOFERS_NORTH_WALES,
  ROOFERS_ADVICEINSIGHT_NORTH_WALES,
  ROOFERS_FEEDBACK_NORTH_WALES,
...
function RoofersInNorthWales() {
  ...
  return (
    <>
      ...
      />
      <VettedSection
        paragraph={VETTED_DATA_ROOFERS_NORTH_WALES}
        vettedHeading1="Find Local Vetted Roofers in "
        vettedHeading2="North Wales"
        breadcrumb={BREADCRUM_DATA_ROOFERS_NORTH_WALES}
        extraButton
        featureRef={featureRef}
      />

      <PopularJobNearMe
        services={POPULAR_SERVICES_ROOFERS_NORTH_WALES}
      ...
      <AboutServicesAndQuestions
        serviceId={113}
        serviceName="Roofing"
        contentBlocks={QUESTION_AND_ABOUT_SERVICE_ROOFERS_NORTH_WALES}
      />
      ...
      <FAQ
        ...
        data={ROOFERS_FREQUENTLY_DATA_NORTH_WALES}
      />
...
export default RoofersInNorthWales;