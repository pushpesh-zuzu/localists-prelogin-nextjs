...
import {
  BREADCRUM_DATA_ROOFERS_MORECAMBE,
  ROOFERS_FREQUENTLY_DATA_MORECAMBE,
  POPULAR_SERVICES_ROOFERS_MORECAMBE,
  QUESTION_AND_ABOUT_SERVICE_ROOFERS_MORECAMBE,
  ROOFERS_ADVICEINSIGHT_MORECAMBE,
  ROOFERS_FEEDBACK_MORECAMBE,
...
function RoofersInMorecambe() {
  ...
  return (
    <>
      ...
      />
      <VettedSection
        paragraph={VETTED_DATA_ROOFERS_MORECAMBE}
        vettedHeading1="Find Local Vetted Roofers in "
        vettedHeading2="Morecambe"
        breadcrumb={BREADCRUM_DATA_ROOFERS_MORECAMBE}
        extraButton
        featureRef={featureRef}
      />

      <PopularJobNearMe
        services={POPULAR_SERVICES_ROOFERS_MORECAMBE}
      ...
      <AboutServicesAndQuestions
        serviceId={113}
        serviceName="Roofing"
        contentBlocks={QUESTION_AND_ABOUT_SERVICE_ROOFERS_MORECAMBE}
      />
      ...
      <FAQ
        ...
        headdingblue="FAQ's"
        headingblack=""
        data={ROOFERS_FREQUENTLY_DATA_MORECAMBE}
      />
...
export default RoofersInMorecambe;
