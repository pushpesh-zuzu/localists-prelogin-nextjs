...
import {
  BREADCRUM_DATA_ROOFERS_ORMSKIRK,
  ROOFERS_FREQUENTLY_DATA_ORMSKIRK,
  POPULAR_SERVICES_ROOFERS_ORMSKIRK,
  QUESTION_AND_ABOUT_SERVICE_ROOFERS_ORMSKIRK,
  ROOFERS_ADVICEINSIGHT_ORMSKIRK,
  ROOFERS_FEEDBACK_ORMSKIRK,
  ROOFERS_DATA_ORMSKIRK,
  ROOFERS_TABDATA_ORMSKIRK,
  VETTED_DATA_ROOFERS_ORMSKIRK,
  NEARBY_PLACES_ROOFER_ORMSKIRK
} from "./RoofersInOrmskirkData";
...
function RoofersInOrmskirk() {
  ...
  return (
    <>
      ...
      <FAQScript FAQ={ROOFERS_FREQUENTLY_DATA_ORMSKIRK} />
      <HeroSectionLocation 
        heading1="Roofers"
        heading2="Ormskirk"
        description={`Looking for <a href="/en/gb/roofers-near-me" target="_blank" rel="noopener noreferrer">roofers near you</a>? Enter your postcode now, tell us what you need, and receive up to 5 free no-obligation quotes from the highest quality roofing professionals in Ormskirk. `}
      ...
      />
      <VettedSection
        paragraph={VETTED_DATA_ROOFERS_ORMSKIRK}
        vettedHeading1="Find Local Vetted Roofers in "
        vettedHeading2="Ormskirk"
        breadcrumb={BREADCRUM_DATA_ROOFERS_ORMSKIRK}
        extraButton
        featureRef={featureRef}
      />

      <PopularJobNearMe
        services={POPULAR_SERVICES_ROOFERS_ORMSKIRK}
      ...
      <AboutServicesAndQuestions
        serviceId={113}
        serviceName="Roofing"
        contentBlocks={QUESTION_AND_ABOUT_SERVICE_ROOFERS_ORMSKIRK}
      />

      <div ref={featureRef} style={{ overflowAnchor: "none" }}>
        <Feature county='Lancashire' cityName='Ormskirk' serviceId={113} serviceName="Roofing" featureRef={featureRef} />
      </div>

      <HireRelatedToServiceNearMe
        heading1="Hire with"
        heading2="confidence."
        tabData={ROOFERS_TABDATA_ORMSKIRK}
        activeTabkey="popular"
        heightClass="min-h-[400px] [@media(max-width:360px)]:min-h-[422px]  h-auto md:h-auto lg:h-[485.5px]"
      />
      <AdviceInsightNearMe
        articles={ROOFERS_ADVICEINSIGHT_ORMSKIRK}
      ...
      <FAQ
        ...
        data={ROOFERS_FREQUENTLY_DATA_ORMSKIRK}
      />
      <UserFeedbackNearMe2 feedbackData={ROOFERS_FEEDBACK_ORMSKIRK} />
      <DiscoverNearMe homeData={ROOFERS_DATA_ORMSKIRK} />
      <NearmeMember
        description={`“The thing I like about Localists is they don’t tie you down to any monthly contracts and the leads are generally better.  When I’m quiet, I just hop on the website and get a few leads to tie me over.”`}
        desktopImage="/nearme/Roofing/roofingmember.webp"
        mobileImage="/nearme/Roofing/roofingmembermobile.webp"
      />
      <NearbyPlaces NearByPlacesData={NEARBY_PLACES_ROOFER_ORMSKIRK}/>
      <Footer />
    </>
  );
}
export default RoofersInOrmskirk;