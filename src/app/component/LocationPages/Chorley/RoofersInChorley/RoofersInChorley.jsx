...
import {
  BREADCRUM_DATA_ROOFERS_CHORLEY,
  ROOFERS_FREQUENTLY_DATA_CHORLEY,
  POPULAR_SERVICES_ROOFERS_CHORLEY,
  QUESTION_AND_ABOUT_SERVICE_ROOFERS_CHORLEY,
  ROOFERS_ADVICEINSIGHT_CHORLEY,
  ROOFERS_FEEDBACK_CHORLEY,
...
function RoofersInChorley() {
  ...
  return (
    <>
      ...
      />
      <VettedSection
        paragraph={VETTED_DATA_ROOFERS_CHORLEY}
        vettedHeading1="Find Local Vetted Roofers in "
        vettedHeading2="Chorley"
        breadcrumb={BREADCRUM_DATA_ROOFERS_CHORLEY}
        extraButton
        featureRef={featureRef}
      />

      <PopularJobNearMe
        services={POPULAR_SERVICES_ROOFERS_CHORLEY}
      ...
      <AboutServicesAndQuestions
        serviceId={113}
        serviceName="Roofing"
        contentBlocks={QUESTION_AND_ABOUT_SERVICE_ROOFERS_CHORLEY}
      />

      <div ref={featureRef} style={{ overflowAnchor: "none" }}>
        <Feature county='Cheshire East' cityName='Chorley' serviceId={113} serviceName="Roofing" featureRef={featureRef} />
      </div>
      ...
      <FAQ
        ...
        data={ROOFERS_FREQUENTLY_DATA_CHORLEY}
      />
...
export default RoofersInChorley;