...
import {
  BREADCRUM_DATA_ROOFERS_FLEETWOOD,
  FREQUENTLY_DATA_FLEETWOOD,
  POPULAR_SERVICES_ROOFERS_FLEETWOOD,
  QUESTION_AND_ABOUT_SERVICE_ROOFERS_FLEETWOOD,
  ROOFERS_ADVICEINSIGHT_FLEETWOOD,
  ROOFERS_FEEDBACK_FLEETWOOD,
  ROOFERS_DATA_FLEETWOOD,
  ROOFERS_TABDATA_FLEETWOOD,
  VETTED_DATA_ROOFERS_FLEETWOOD,
  NEARBY_PLACES_ROOFER_FLEETWOOD
} from "./RoofersInFleetwoodData";
...
function RoofersInFleetwood() {
  ...
  return (
    <>
      ...
      <PopularJobNearMe
        services={POPULAR_SERVICES_ROOFERS_FLEETWOOD}
      ...
      <AboutServicesAndQuestions
        serviceId={113}
        serviceName="Roofing"
        contentBlocks={QUESTION_AND_ABOUT_SERVICE_ROOFERS_FLEETWOOD}
      />
      ...
      <FAQ
        ...
        headdingblue="FAQ's"
        headingblack=""
        data={FREQUENTLY_DATA_FLEETWOOD}
      />
...
export default RoofersInFleetwood;
