...
import {
    BREADCRUM_DATA_ROOFERS_ALDERLEY_EDGE,
    ROOFERS_FREQUENTLY_DATA_ALDERLEY_EDGE,
    POPULAR_SERVICES_ROOFERS_ALDERLEY_EDGE,
    QUESTION_AND_ABOUT_SERVICE_ROOFERS_ALDERLEY_EDGE,
    ROOFERS_ADVICEINSIGHT_ALDERLEY_EDGE,
    ROOFERS_FEEDBACK_ALDERLEY_EDGE,
...
function RoofersInAlderleyEdge() {
    ...
    return (
        <>
            ...
            <FAQScript FAQ={ROOFERS_FREQUENTLY_DATA_ALDERLEY_EDGE} />
            <HeroSectionLocation 
                heading1="Roofers"
                heading2="Alderley Edge"
                description="Get free, no-obligation quotes from experienced roofers in Alderley Edge. Simply enter your quotes below, share a few details about the job you need done, and the best roofers in Alderley Edge will reach out to you in under a minute."
            ...
            />
            <VettedSection
                paragraph={VETTED_DATA_ROOFERS_ALDERLEY_EDGE}
                vettedHeading1="Find Local Vetted Roofers in "
                vettedHeading2="Alderley Edge"
                breadcrumb={BREADCRUM_DATA_ROOFERS_ALDERLEY_EDGE}
                extraButton
                featureRef={featureRef}
            />

            <PopularJobNearMe
                services={POPULAR_SERVICES_ROOFERS_ALDERLEY_EDGE}
            ...
            <AboutServicesAndQuestions
                serviceId={113}
                serviceName="Roofing"
                contentBlocks={QUESTION_AND_ABOUT_SERVICE_ROOFERS_ALDERLEY_EDGE}
            />

            <div ref={featureRef} style={{ overflowAnchor: "none" }}>
                <Feature county='Cheshire East' cityName='Alderley Edge' serviceId={113} serviceName="Roofing" featureRef={featureRef} />
            </div>
            ...
            />
            <AdviceInsightNearMe
                articles={ROOFERS_ADVICEINSIGHT_ALDERLEY_EDGE}
            ...
            <FAQ
                ...
                data={ROOFERS_FREQUENTLY_DATA_ALDERLEY_EDGE}
            />
            <UserFeedbackNearMe2 feedbackData={ROOFERS_FEEDBACK_ALDERLEY_EDGE} />
            <DiscoverNearMe homeData={ROOFERS_DATA_ALDERLEY_EDGE} />
...
export default RoofersInAlderleyEdge;