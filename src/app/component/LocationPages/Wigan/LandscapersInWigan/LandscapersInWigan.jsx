...
import {
  BREADCRUM_DATA_LANDSCAPING_WIGAN,
  FREQUENTLY_DATA_LANDSCAPING_WIGAN,
  POPULAR_SERVICES_LANDSCAPING_WIGAN,
  QUESTION_AND_ABOUT_SERVICE_LANDSCAPING_WIGAN,
  LANDSCAPING_ADVICEINSIGHT_WIGAN,
  LANDSCAPING_FEEDBACK_WIGAN,
...
function LandscapersInWigan() {
  ...
  return (
    <>
      ...
      />
      <VettedSection
        paragraph={VETTED_DATA_LANDSCAPING_WIGAN}
        vettedHeading1="Find Local Vetted Landscapers in "
        vettedHeading2="Wigan"
        breadcrumb={BREADCRUM_DATA_LANDSCAPING_WIGAN}
        extraButton
        featureRef={featureRef}
        featureButtonText="View Landscapers"
      />
      <LandScapingGardenPopularJobs
        services={POPULAR_SERVICES_LANDSCAPING_WIGAN}
      ...
      <FAQ
        ...
        headdingblue="FAQ's"
        headingblack=""
        data={FREQUENTLY_DATA_LANDSCAPING_WIGAN}
      />
...
export default LandscapersInWigan;
