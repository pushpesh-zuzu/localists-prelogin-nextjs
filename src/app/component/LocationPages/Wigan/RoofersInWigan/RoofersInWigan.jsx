...
import {
  BREADCRUM_DATA_ROOFERS_WIGAN,
  FREQUENTLY_DATA_WIGAN,
  POPULAR_SERVICES_ROOFERS_WIGAN,
  QUESTION_AND_ABOUT_SERVICE_ROOFERS_WIGAN,
  ROOFERS_ADVICEINSIGHT_WIGAN,
  ROOFERS_FEEDBACK_WIGAN,
  ROOFERS_DATA_WIGAN,
...
function RoofersInWigan() {
  ...
  return (
    <>
      ...
      />
      <VettedSection
        paragraph={VETTED_DATA_ROOFERS_WIGAN}
        vettedHeading1="Find Local Vetted Roofers in "
        vettedHeading2="Wigan"
        breadcrumb={BREADCRUM_DATA_ROOFERS_WIGAN}
        extraButton
        featureRef={featureRef}
      />

      <PopularJobNearMe
        services={POPULAR_SERVICES_ROOFERS_WIGAN}
      ...
      <AboutServicesAndQuestions
        serviceId={113}
        serviceName="Roofing"
        contentBlocks={QUESTION_AND_ABOUT_SERVICE_ROOFERS_WIGAN}
      />
