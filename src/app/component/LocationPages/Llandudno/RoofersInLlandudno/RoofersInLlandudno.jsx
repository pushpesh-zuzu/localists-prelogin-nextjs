...
import {
  BREADCRUM_DATA_ROOFERS_LLANDUDNO,
  ROOFERS_FREQUENTLY_DATA_LLANDUDNO,
  POPULAR_SERVICES_ROOFERS_LLANDUDNO,
  QUESTION_AND_ABOUT_SERVICE_ROOFERS_LLANDUDNO,
  ROOFERS_ADVICEINSIGHT_LLANDUDNO,
  ROOFERS_FEEDBACK_LLANDUDNO,
...
function RoofersInLlandudno() {
  ...
  return (
    <>
      ...
      />
      <VettedSection
        paragraph={VETTED_DATA_ROOFERS_LLANDUDNO}
        vettedHeading1="Find Local Vetted Roofers in "
        vettedHeading2="Llandudno"
        breadcrumb={BREADCRUM_DATA_ROOFERS_LLANDUDNO}
        extraButton
        featureRef={featureRef}
      />

      <PopularJobNearMe
        services={POPULAR_SERVICES_ROOFERS_LLANDUDNO}
      ...
      <AboutServicesAndQuestions
        serviceId={113}
        serviceName="Roofing"
        contentBlocks={QUESTION_AND_ABOUT_SERVICE_ROOFERS_LLANDUDNO}
      />
      ...
      <FAQ
        ...
        data={ROOFERS_FREQUENTLY_DATA_LLANDUDNO}
      />
...
export default RoofersInLlandudno;