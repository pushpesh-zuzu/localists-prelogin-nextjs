...
import {
    BREADCRUM_DATA_ROOFERS_ULVERSTON,
    FREQUENTLY_DATA_ULVERSTON,
    POPULAR_SERVICES_ROOFERS_ULVERSTON,
    QUESTION_AND_ABOUT_SERVICE_ROOFERS_ULVERSTON,
    ROOFERS_ADVICEINSIGHT_ULVERSTON,
    ROOFERS_FEEDBACK_ULVERSTON,
    ROOFERS_DATA_ULVERSTON,
    ROOFERS_TABDATA_ULVERSTON,
    VETTED_DATA_ROOFERS_ULVERSTON,
    NEARBY_PLACES_ROOFER_ULVERSTON
} from "./RoofersInUlverstonData";
...
function RoofersInUlverston() {
    ...
    return (
        <>
            ...
            />
            <VettedSection
                paragraph={VETTED_DATA_ROOFERS_ULVERSTON}
                vettedHeading1="Find Local Vetted Roofers in "
                vettedHeading2="Ulverston"
                breadcrumb={BREADCRUM_DATA_ROOFERS_ULVERSTON}
                extraButton
                featureRef={featureRef}
            />

            <PopularJobNearMe
                services={POPULAR_SERVICES_ROOFERS_ULVERSTON}
            ...
            <AboutServicesAndQuestions
                serviceId={113}
                serviceName="Roofing"
                contentBlocks={QUESTION_AND_ABOUT_SERVICE_ROOFERS_ULVERSTON}
            />
            ...
            <FAQ
                ...
                headdingblue="FAQ's"
                headingblack=""
                data={FREQUENTLY_DATA_ULVERSTON}
            />
...
export default RoofersInUlverston;