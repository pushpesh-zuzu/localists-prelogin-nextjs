...
import {
    BREADCRUM_DATA_ROOFERS_CROSBY,
    ROOFERS_FREQUENTLY_DATA_CROSBY,
    POPULAR_SERVICES_ROOFERS_CROSBY,
    QUESTION_AND_ABOUT_SERVICE_ROOFERS_CROSBY,
    ROOFERS_ADVICEINSIGHT_CROSBY,
    ROOFERS_FEEDBACK_CROSBY,
    ROOFERS_DATA_CROSBY,
    ROOFERS_TABDATA_CROSBY,
    VETTED_DATA_ROOFERS_CROSBY,
    NEARBY_PLACES_ROOFER_CROSBY
} from "./RoofersInCrosbyData";
...
function RoofersInCrosby() {
    ...
    return (
        <>
            ...
            <FAQScript FAQ={ROOFERS_FREQUENTLY_DATA_CROSBY} />
            <HeroSectionLocation 
                heading1="Roofers"
                heading2="Crosby"
                description="Get completely free quotes from trusted roofing professionals in Crosby with no obligation to commit. Enter your postcode, share the details of the issues, and receive quotes. Takes under a minute."
            ...
            />
            <VettedSection
                paragraph={VETTED_DATA_ROOFERS_CROSBY}
                vettedHeading1="Find Local Vetted Roofers in "
                vettedHeading2="Crosby"
                breadcrumb={BREADCRUM_DATA_ROOFERS_CROSBY}
                extraButton
                featureRef={featureRef}
            />

            <PopularJobNearMe
                services={POPULAR_SERVICES_ROOFERS_CROSBY}
            ...
            <AboutServicesAndQuestions
                serviceId={113}
                serviceName="Roofing"
                contentBlocks={QUESTION_AND_ABOUT_SERVICE_ROOFERS_CROSBY}
            />

            <div ref={featureRef} style={{ overflowAnchor: "none" }}>
                <Feature county='North Lincolnshire' cityName='Crosby' serviceId={113} serviceName="Roofing" featureRef={featureRef} />
            </div>

            <HireRelatedToServiceNearMe
                heading1="Hire with"
                heading2="confidence."
                tabData={ROOFERS_TABDATA_CROSBY}
                activeTabkey="popular"
            />
            <AdviceInsightNearMe
                articles={ROOFERS_ADVICEINSIGHT_CROSBY}
            ...
            <FAQ
                ...
                data={ROOFERS_FREQUENTLY_DATA_CROSBY}
            />
            <UserFeedbackNearMe2 feedbackData={ROOFERS_FEEDBACK_CROSBY} />
            <DiscoverNearMe homeData={ROOFERS_DATA_CROSBY} />
            <NearmeMember
                description={`“The thing I like about Localists is they don’t tie you down to any monthly contracts and the leads are generally better.  When I’m quiet, I just hop on the website and get a few leads to tie me over.”`}
                desktopImage="/nearme/Roofing/roofingmember.webp"
                mobileImage="/nearme/Roofing/roofingmembermobile.webp"
            />
            <NearbyPlaces NearByPlacesData={NEARBY_PLACES_ROOFER_CROSBY} />
            <Footer />
        </>
    );
}
export default RoofersInCrosby;