...
import {
  BREADCRUM_DATA_ROOFERS_BRADFORD,
  FREQUENTLY_DATA_BRADFORD,
  POPULAR_SERVICES_ROOFERS_BRADFORD,
  QUESTION_AND_ABOUT_SERVICE_ROOFERS_BRADFORD,
  ROOFERS_ADVICEINSIGHT_BRADFORD,
  ROOFERS_FEEDBACK_BRADFORD,
...
function RoofersInBradford() {
  ...
  return (
    <>
      ...
      <FAQScript FAQ={FREQUENTLY_DATA_BRADFORD} />
      <HeroSectionLocation 
        heading1="Roofers"
        heading2="Bradford"
      ...
      />
      <VettedSection
        paragraph={VETTED_DATA_ROOFERS_BRADFORD}
        vettedHeading1="Find Local Vetted Roofers in "
        vettedHeading2="Bradford"
        breadcrumb={BREADCRUM_DATA_ROOFERS_BRADFORD}
        extraButton
        featureRef={featureRef}
      />

      <PopularJobNearMe
        services={POPULAR_SERVICES_ROOFERS_BRADFORD}
      ...
      <AboutServicesAndQuestions
        serviceId={113}
        serviceName="Roofing"
        contentBlocks={QUESTION_AND_ABOUT_SERVICE_ROOFERS_BRADFORD}
      />
      ...
      />
      <AdviceInsightNearMe
        articles={ROOFERS_ADVICEINSIGHT_BRADFORD}
      ...
      <FAQ
        ...
        headdingblue="FAQ's"
        headingblack=""
        data={FREQUENTLY_DATA_BRADFORD}
      />
      <UserFeedbackNearMe2 feedbackData={ROOFERS_FEEDBACK_BRADFORD} />
      <DiscoverNearMe homeData={ROOFERS_DATA_BRADFORD} />
      <NearmeMember
...
export default RoofersInBradford;
