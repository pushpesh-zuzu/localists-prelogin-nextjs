...
import {
  BREADCRUM_DATA_ROOFERS_CREW,
  ROOFERS_FREQUENTLY_DATA_CREW,
  POPULAR_SERVICES_ROOFERS_CREW,
  QUESTION_AND_ABOUT_SERVICE_ROOFERS_CREW,
  ROOFERS_ADVICEINSIGHT_CREW,
  ROOFERS_FEEDBACK_CREW,
  ROOFERS_DATA_CREW,
...
function RoofersInCrew() {
  ...
  return (
    <>
      ...
      />
      <VettedSection
        paragraph={VETTED_DATA_ROOFERS_CREW}
        vettedHeading1="Find Local Vetted Roofers in "
        vettedHeading2="Crewe"
        breadcrumb={BREADCRUM_DATA_ROOFERS_CREW}
        extraButton
        featureRef={featureRef}
      />

      <PopularJobNearMe
        services={POPULAR_SERVICES_ROOFERS_CREW}
      ...
      <AboutServicesAndQuestions
        serviceId={113}
        serviceName="Roofing"
        contentBlocks={QUESTION_AND_ABOUT_SERVICE_ROOFERS_CREW}
      />
