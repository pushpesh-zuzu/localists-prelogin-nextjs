export const QUESTION_AND_ABOUT_SERVICE_ROOFERS_CREW = [
  {
    type: "h2",
    text: "Why Localists is the best place to find roofers in Crewe",
  },
  {
    type: "p",
...
export const ROOFERS_TABDATA_CREW = {
  popular: [
    {
...
export const BREADCRUM_DATA_ROOFERS_CREW = [
...
export const POPULAR_SERVICES_ROOFERS_CREW = [
  "Roof Repair",
  "Flashing",
  "Waterproofing",
  "Roof Replacement",
...
export const ROOFERS_DATA_CREW = [
  {
    id: 1,
    title: "Home & Garden",
