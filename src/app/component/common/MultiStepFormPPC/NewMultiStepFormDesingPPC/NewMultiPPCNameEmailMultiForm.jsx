  ...
  return (
    <BackgroundWrapperNameEmailMultiForm>
      <NewMultiPPCCardLayoutWrapper
        ...
        progressPercentage={isBannerText && !isInitialLoading ? 0 : progressPercentage}
      >
        {isInitialLoading ? (
          ...
          <div className="flex flex-col gap-[10px] -mb-5 pb-6">
            <img
...
export default NewMultiPPCNameEmailMultiForm;
