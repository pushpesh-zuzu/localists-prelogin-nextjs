...
const CarouselForHowItWork = memo(function Carousel({
  children,
  visibleItems = 4,
          ...
          <div className="flex justify-center mt-8 space-x-2">
            {Array.from({ length: totalSlides }).map((_, index) => (
              <button
                ...
                className={`${
                  index === currentIndex ? "w-[51px] md:w-[47px] xl:w-[89px]" : "w-[11px] md:w-3 xl:w-6"
...
export default CarouselForHowItWork;
