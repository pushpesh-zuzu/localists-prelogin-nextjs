...
const NewBuyerRequestDescribeYourRequestModal = ({ nextStep, progressPercent, sellers }) => {
                    ...
                    {buyerStep === 10 ? (
                        ...
                        <div className=" pb-[20px] flex-shrink-0 text-center">
                                                        ...
                                                        >
                                                            ...
                                                            <span className="max-w-[170px] md:max-w-[100%">Your request has been submitted</span>
                                                        </h6>
                                                        </div>
                            
                            <textarea
                                className={`w-full custom-textarea rounded-[20px] border-2 border-[#00aef3] custom-placeholder shadow-[0px_0px_2px_0.5px_rgba(0,0,0,0.1)] p-3.5 resize-none md:text-sm font-['Arial'] font-bold ${textError ? "border-red-500" : "border-[#00afe3]"
                                    }`}
                                value={text}
                            ...
                            <label
                                className={`flex justify-center rounded-full border-2 border-[#00aef3] items-center gap-2 text-[#253238] px-6 py-3 md:px-3 md:py-[21px] text-xs font-medium cursor-pointer transition-colors hover:bg-[#d4ebff] w-full mt-3 ${fileError ? "border border-red-500" : ""
                                    }`}
                            >
                                <svg
