...
import NewBuyerRegistrationNameEmailPhoneModal from "../NewBuyerRegistrationDesign/NewBuyerRegistrationNameEmailPhoneModal";
import NewBuyerRegistrationServiceAndPostCodeModal from "../NewBuyerRegistrationDesign/NewBuyerRegistrationServiceAndPostCodeModal";
import NewBuyerRegistrationQuestionsModal from "../NewBuyerRegistrationDesign/NewBuyerRegistrationQuestionsModal";
import NewBuyerRegistrationReEnterMobileNumber from "../NewBuyerRegistrationDesign/NewBuyerRegistrationReEnterMobileNumber";
import NewBuyerRegistrationOtpVerification from "../NewBuyerRegistrationDesign/NewBuyerRegistrationOtpVerification";
...
function NewBuyerRegistrationForm({
  ...
  return (
    <>
      {buyerStep === 1 && (
        <NewBuyerRegistrationNameEmailPhoneModal
          nextStep={nextStep}
      ...
      {buyerStep === 2 && (
        <NewBuyerRegistrationServiceAndPostCodeModal
          nextStep={nextStep}
          formData={buyerRequest}
      ...
      {buyerStep === 3 && (
        <NewBuyerRegistrationQuestionsModal
      ...
      {buyerStep === 7 && (
        <NewBuyerRegistrationDescribeYourRequest
          nextStep={nextStep}
          onClose={handleClose}
          setShowConfirmModal={setShowConfirmModal}
        />
...
export default NewBuyerRegistrationForm;
