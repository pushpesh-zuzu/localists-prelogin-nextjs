...
const NewBuyerRegistrationServiceAndPostCodeModal = ({
  nextStep,
  serviceId,
  serviceName,
  onClose,
  ...
  return (
    <div className="px-7.5 py-6">
      <RequestBuyerModal
        ...
        onBackDisable
        childrenMaxHeight="max-h-[350px] md:max-h-[550px]"
...
export default NewBuyerRegistrationServiceAndPostCodeModal;
