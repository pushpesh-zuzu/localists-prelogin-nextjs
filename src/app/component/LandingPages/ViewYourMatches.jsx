...
const ViewYourMatches = ({
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center shadow-sm">
      <div
        className="relative w-[500px] bg-white px-8 py-10 text-center max-[768px]:w-[70%] max-[768px]:px-[30px] max-[480px]:w-[80%] max-[480px]:px-[25px] max-[350px]:w-[90%] max-[350px]:px-5"
