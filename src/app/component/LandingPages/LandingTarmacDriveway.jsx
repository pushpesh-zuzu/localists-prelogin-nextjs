...
function LandingTarmacDriveway() {
    ...
    return (
        <>
            ...
            <FindDetailAndBannerWrapper
                ...
                welcomModalTitle={LANDING_WELCOM_MODAL_TITLE["tarmac_driveways_ppc"]}
                welcomModalButtonText={
                    LANDING_WELCOM_MODAL_BUTTON_TITLE["tarmac_driveways_ppc"]
                }
            />
...
export default LandingTarmacDriveway