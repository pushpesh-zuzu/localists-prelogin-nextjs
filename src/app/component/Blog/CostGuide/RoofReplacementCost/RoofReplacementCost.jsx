...
function RoofReplacementCost() {
  ...
  return (
    <>
      ...
      <FAQScript FAQ={FREQUENTLY_DATA_ROOFREPLACEMENTCOST_ROOF} />
      <BlogHeroSection
        category="Roofing"
      ...
      <AboutServiceAndQuestionBlog
        ...
        contentBlocks={ROOFREPLACEMENTCOST_QUESTION_AND_ABOUT_SERVICE}
        serviceId={113}
        serviceName="Roofing"
      />
      <FAQ
        data={FREQUENTLY_DATA_ROOFREPLACEMENTCOST_ROOF}
...
export default RoofReplacementCost;
