    ...
    return (
        <>
            <FormWrapper>
                ...
                <div style={{ maxWidth: "592px", margin: "auto" }} className="pb-[23px]">
                    <CardLayoutWrapper
                        title={title}
                    ...
                    >
                        ...
                        <div className="relative flex items-center">
                            <input
                                className={`w-full border border-[#e1e5e9] rounded-lg px-7 py-3 text-base font-medium text-gray-800 transition-all duration-300 focus:outline-none focus:border-[#0096c4] focus:ring-3 focus:ring-[#0096c4]/10 ${error ? "border-red-500" : ""
                                    }`}
