...
// import QuestionAnserMultiStepDriways2 from "../MultiFormDriveways/QuestionAnserMultiStepDriways2";
// import PostcodeSearchDriveways from "../MultiFormDriveways/PostcodeSearchDriveways";
// import QuestionAnswerMultiStepDriveways from "../MultiFormDriveways/QuestionAnswerMultiStepDriveways";
...
import NewLandscapingQA2MultiPPC from "./NewLandscapingQA2MultiPPC";
import NewPostcodeSearchLandscapingMultiform from "./NewPostcodeSearchLandscapingMultiform";
import NewLandscapingQA1MultiPPC from "./NewLandscapingQA1MultiPPC";
import NewMultiPPCNameEmailMultiForm from "../../common/MultiStepFormPPC/NewMultiStepFormDesingPPC/NewMultiPPCNameEmailMultiForm";
import NewMultiPPCPhoneNumberMultiStepForm from "../../common/MultiStepFormPPC/NewMultiStepFormDesingPPC/NewMultiPPCPhoneNumberMultiStepForm";
import NewMultiPPCOTPVerificationMultiStep from "../../common/MultiStepFormPPC/NewMultiStepFormDesingPPC/NewMultiPPCOTPVerificationMultiStep";
import NewMultiPPCMultiStepDescribeYourRequest from "../../common/MultiStepFormPPC/NewMultiStepFormDesingPPC/NewMultiPPCMultiStepDescribeYourRequest";

const NewMultiStepLandscaping = ({ isQuestionWithImage = false }) => {
            ...
            >
              <div className="rounded-lg overflow-hidden relative">
                ...
                >
                  ...
                  {buyerStep === 5 && (
                    <div style={{ maxWidth: "592px", margin: "auto" }}>
                      <NewMultiPPCPhoneNumberMultiStepForm
                        nextStep={nextStep}
                        onBack={prevStep}
                        serviceId={51}
                        setProgressPercentage={setProgressPercentage}
                  ...
                  {buyerStep === 6 && (
                      <NewMultiPPCOTPVerificationMultiStep
                        open
                        nextStep={nextStep}
                        onBack={prevStep}
                  ...
                  {buyerStep === 7 && (
                      ...
                      <NewMultiPPCMultiStepDescribeYourRequest progressPercentage={100} />
...
export default NewMultiStepLandscaping;
